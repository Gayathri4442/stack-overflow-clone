...
const AskQuestion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(
    askQuestion({questionTitle, questionBody, questionTags, userPosted: User.result?.name, userId: User?.result._id}, navigate) );
  };
        ...
        <form onSubmit={handleSubmit}>
          <div className="ask-form-container">
            <label htmlFor="ask-ques-title">
              <h4> Title </h4>
              <p>
                Be specific and imagine you’re asking a question to anotherperson
              </p>
