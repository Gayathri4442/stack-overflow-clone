...
const QuestionsDetails = () => {
  ...
  const handlePostAns = (e, answerLength) =>{
    ...
    if(User === null){
      ...
      if(Answer === ''){
        alert('Enter an answer before sumbitting')
      }else{
        dispatch(postAnswer({ id, noOfAnswers: answerLength + 1, answerBody: Answer, userAnswered: User?.length?.name, userId: User?.result._id }))
        ...
        <>
          {questionsList.data.filter((question) => question._id === id).map((question) => (
              <div key={question._id}>
                ...
                <section className="post-ans-conatainer">
                  <h3>Your Answer</h3>
